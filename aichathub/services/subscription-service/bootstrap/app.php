...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        // despite the subscription-scheduler container running `schedule:work` continuously.
        // Renewal processing has likely never actually run automatically until this fix.
