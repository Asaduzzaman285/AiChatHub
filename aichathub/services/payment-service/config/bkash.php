...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    // Disabled — this app calls the Bkash facade directly from its own
    // controllers (BkashGateway), matching how StripeGateway wraps the Stripe
    // SDK. The package's built-in routes/controllers would be dead,
    // competing infrastructure alongside our own Transaction-table-centric
    // checkout flow.
    'routes' => [
        'enabled' => false,
        'prefix' => 'bkash',
